 ...
 * in a {@link PilotPhysicalListActivity}.
 */
public class PilotPhysicalDetailActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pilotphysical_detail);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            //
            navigateUpTo(new Intent(this, PilotPhysicalListActivity.class));
            return true;
        }
